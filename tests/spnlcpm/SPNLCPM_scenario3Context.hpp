...
/**
 * @file SPNLCPM_scenario3Context.hpp
 * @author S. Martorana (salvatoremartorana@hotmail.com)
 * @author F. Abrignani (federignoli@hotmail.it)
 * @brief Alias SPNLCPM_scenario3Context.
 * @version 0.1
 * @date 2023-10-06
 * @private
...
namespace SPNLCPM_scenario3{
    ...
    void threadFunction2(thread_context* c ,int i, boost::fairness::spinlock_priority_mutex<5>& m) {
        if (m.try_lock(i)){
            ret.push_back(true);
            c->switchContext();
            m.unlock();

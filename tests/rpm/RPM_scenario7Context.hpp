...
/**
 * @file RPM_scenario7Context.hpp
 * @author S. Martorana (salvatoremartorana@hotmail.com)
 * @author F. Abrignani (federignoli@hotmail.it)
 * @brief Alias RPM_scenario7Context.
 * @version 0.1
 * @date 2023-10-06
 * @private
...
namespace RPM_scenario7{
    ...
    void threadFunction2(thread_context* c, int i, boost::fairness::recursive_priority_mutex<10>& m) {
        if (m.try_lock(i)){
            if (m.try_lock(i+2)){
                ret.push_back(true);
                c->switchContext();

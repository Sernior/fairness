 ...
 * 
 */
#ifndef BOOST_FAIRNESS_PRIORITY_MUTEX_TATAS_HPP
#define BOOST_FAIRNESS_PRIORITY_MUTEX_TATAS_HPP
#include <atomic>
#include <array>
...
namespace boost::fairness{
    ...
    class priority_mutex{
        ...
        void unlock(){
            ...
            // we use an internal spinlock based on tatas just to avoid thundering herd here instead of using tatas directly
...
#endif // BOOST_FAIRNESS_PRIORITY_MUTEX_TATAS_HPP
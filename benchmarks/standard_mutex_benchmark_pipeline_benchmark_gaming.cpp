/**
 * @file standard_mutex_benchmark_pipeline_benchmark_gaming.cpp
 * @author S. Martorana (salvatoremartorana@hotmail.com)
 * @author F. Abrignani (federignoli@hotmail.it)
 * @brief Alias standard_mutex_benchmark_pipeline_benchmark_gaming.
 * @version 0.1
 * @date 2024-03-10
 * @private
...
BENCHMARK(standard_mutex_benchmark::pipeline_benchmark_gaming)->Threads(BENCHMARK_THREADS);

...
namespace standard_recursive_mutex_benchmark{
    ...
    void R_STD_LockUnlock(benchmark::State& state) {
        std::recursive_mutex mf;
    ...
    void R_STD_pipeline_benchmark_long(benchmark::State& state) {
    ...
    void R_STD_pipeline_benchmark_gaming(benchmark::State& state) {
    ...
    void R_STD_pipeline_benchmark_audio(benchmark::State& state) {
    ...
    void R_STD_pipeline_benchmark_fast(benchmark::State& state) { /*  */
        std::array<int, 8> prios {0, 2, 2, 1, 1, 3, 3, 0};
        std::array<int, 8> preCT {2000, 1500, 2000, 3000, 1000, 500, 500, 2000};
        int CT = 1000;
        std::array<int, 8> postCT {5000, 3000, 2000, 2500, 1000, 1500, 1500, 4500};

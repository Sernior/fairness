/**
 * @file priority_mutex_benchmark_pipeline_benchmark_gaming.cpp
 * @author S. Martorana (salvatoremartorana@hotmail.com)
 * @author F. Abrignani (federignoli@hotmail.it)
 * @brief Alias priority_mutex_benchmark_pipeline_benchmark_gaming.
 * @version 0.1
 * @date 2024-03-05
 * @private
...
BENCHMARK(priority_mutex_benchmark::pipeline_benchmark_gaming)->Threads(BENCHMARK_THREADS);

/**
 * @file spinlock_priority_mutex_benchmark_pipeline_benchmark_long.cpp
 * @author S. Martorana (salvatoremartorana@hotmail.com)
 * @author F. Abrignani (federignoli@hotmail.it)
 * @brief Alias spinlock_priority_mutex_benchmark_pipeline_benchmark_long.
 * @version 0.1
 * @date 2024-03-05
 * @private
...
BENCHMARK(spinlock_priority_mutex_benchmark::pipeline_benchmark_long)->Threads(BENCHMARK_THREADS);

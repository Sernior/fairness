/**
 * @file spinlock_priority_mutex_benchmark_pipeline_benchmark_audio.cpp
 * @author S. Martorana (salvatoremartorana@hotmail.com)
 * @author F. Abrignani (federignoli@hotmail.it)
 * @brief Alias spinlock_priority_mutex_benchmark_pipeline_benchmark_audio.
 * @version 0.1
 * @date 2024-03-10
 * @private
...
BENCHMARK(spinlock_priority_mutex_benchmark::pipeline_benchmark_audio)->Threads(BENCHMARK_THREADS);

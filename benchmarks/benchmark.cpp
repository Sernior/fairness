...
BENCHMARK(_SLM_PM_pipeline_benchmark::SLMPM_LockUnlock)->Threads(8);
...
#endif
BENCHMARK(_SLM_PM_pipeline_benchmark::SLM_pipeline_benchmark_audio)->Threads(8);

BENCHMARK(_PM_pipeline_benchmark::PM_pipeline_benchmark_fast)->Threads(8);
BENCHMARK(_SLM_PM_pipeline_benchmark::SLM_pipeline_benchmark_fast)->Threads(8);
#ifdef BOOST_FAIRNESS_EXPERIMENTAL_MUTEXES
